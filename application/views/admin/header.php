        ...
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
              ...
              <!-- <img alt="branding logo" src="<?php echo base_url('assets/img/camssuccess2.png'); ?>" data-expand="<?php echo base_url('assets/img/camssuccess2.png'); ?>" data-collapse="<?php echo base_url('assets/img/camssuccess2.png'); ?>" class="brand-logo" height="40"> -->
              <h2 class="text-white">CTECH </h2>
              </a>
            </li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?php echo base_url('assets/admincss/'); ?>images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">Admin</span></a>
