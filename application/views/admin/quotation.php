      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Add Quotation</h2>
          </div>
       ...
       <?php if($this->session->flashdata('msg')): ?>
        ...
        <div class="card">
            ...
            <div class="card-body collapse in p-2">
                <form action="<?php  echo base_url('admin/addQuotation');?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <input type="text" name="gst" class="form-control" value="<?php echo set_value('gst');?>" placeholder="GST %">
                  ...
                  <div class="form-group">
                    <input type="submit" value="Add Quotation" class="btn btn-success">
                  </div>
                </form>
            </div>
        </div>
