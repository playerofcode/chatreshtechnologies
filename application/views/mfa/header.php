        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?php echo base_url('assets/admincss/'); ?>images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">MFA</span></a>
                <div class="dropdown-menu dropdown-menu-right">
                 ...
                 <!--  <a href="#" class="dropdown-item"><i class="icon-clipboard2"></i> Task</a> -->
                  ...
                  <a href="<?php echo base_url('mfa/change_password');?>" class="dropdown-item"><i class="icon-android-settings"></i> Change Password</a>
                  <div class="dropdown-divider"></div><a href="<?php echo base_url('mfa/logout');?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
