                    ...
                    <table class="table mb-0" id="my_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Are you sure?');"href="<?php echo base_url('mfa/deleteRaiseTicket/'.$key->id);?>" class="btn btn-danger btn-sm">Delete</a></td>
                            </tr>
                            <?php $i++;endforeach ?>
                        </tbody>
                    </table>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('mfa/createTicket');?>" method="post">
