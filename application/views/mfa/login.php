        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1">
                         ...
                         <img src="<?php echo base_url('assets/home/img/ctech_web.png');?>" alt="branding logo" height="100"> </div>
                         <h2>Master Franchise Agent</h2>
                </div>
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    ...
                    <?php endif;?>
                    <form class="form-horizontal form-simple" action="<?php echo base_url('mfa/login');?>" method="post">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" name="email" class="form-control form-control-lg input-lg" id="user-name" placeholder="Enter Email" required>
                        ...
                        <fieldset class="form-group row">
                            ...
                            <div class="col-md-6 col-xs-12 text-xs-center text-md-right"><a href="<?php echo base_url('mfa/register');?>" class="card-link">Create Account</a></div>
                        </fieldset>
