...
<head>
  ...
  <!-- OG PAroperties -->
   <meta property="og:title" content="Chatresh Technologies Pvt. Ltd.">
    <meta property="og:url" content="<?php echo base_url();?>">
    <meta property="og:type" content="website"/>
    <meta property="og:description" content="Chatresh Technologies Pvt. Ltd. is a technology consulting, system integration, managed business services, and digital transformation company. Our teams guide our clients throughout the whole digital transformation process and synchronize all stakeholders to bring their expectations to life. We match our tailor-made, coordinated expertise with a vibrant ecosystem of digital innovators to deliver the most sustainable outcomes. We go to great lengths for our customers and accelerate their digital transformation by enabling their Cloud, Mobility, Data Analytics, IoT, System Integration and Security journeys to address the dynamic requirements of a variety of industry verticals, predominantly Government & Public Sector, Large and Medium Businesses and many more.">
     <meta property="og:image" content="<?php echo base_url('assets/home/')?>img/logo.jpg">
