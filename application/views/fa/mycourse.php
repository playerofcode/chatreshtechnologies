      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">My Course</h2>
          </div>
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('partner/dashboard');?>">Home</a>
                </li>
                <li class="breadcrumb-item active">My Course
                </li>
              </ol>
            </div>
          </div>
                    ...
                    <table class="table mb-0" id="my_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?php echo base_url('partner/setCoursePrice/');?>" method="POST">
                                        <input type="hidden" name="id" value="<?php echo $key['id'];?>">
                                        <input type="number" value="<?php echo $key['sell_price'];?>" name="sell_price" style="width:60px;" >
                                        <input type="submit" value="Set" class="btn btn-success btn-sm">
                                    </form>
                                </td>
                            </tr>
                            <?php $i++;endforeach ?>
