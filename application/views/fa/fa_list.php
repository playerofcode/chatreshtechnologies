        ...
        <div class="card">
            <div class="card-header">
                <div style="float:left;">
                    <button class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#myModal">+ Add Franchise Agent</button>
                </div>
            </div>
                    ...
                    <table class="table mb-0" id="my_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Are you sure want to delete');" href="<?php echo base_url('mfa/deleteFa/'.$key->id);?>" class="btn btn-danger btn-sm">Delete</a></td>
                            </tr>
                            <?php $i++;endforeach ?>
                        </tbody>
                    </table>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('mfa/addFa');?>" method="post">
      ...
      <div class="modal-footer">
        <input type="submit" value="Add Franchise Agent" class="btn btn-success">
