                   ...
                   <div class="card mb-1">
                       <div class="card-body p-2 text-xs-center">
                        <?php if($kyc_status == 'requested'):?>
                           ...
                           Complete Your KYC <a href="<?php echo base_url('fa/kyc');?>" class="btn btn-sm btn-primary">Complete KYC</a>
                       <?php else: ?>
                             <?php endif; ?>
                       </div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
               <b> Commission Chart</b> <p style="float: right;"><b>Promo Code : </b> <?php echo "FA".$fa_id; ?></p>
            </div>
            <div class="card-body">
